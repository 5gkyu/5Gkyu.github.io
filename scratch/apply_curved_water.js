...
console.log('Generating curved water stargazer.js! Total count:', totalCount);

const outputCode = `/**
 * stargazer.js - Starry Mirror & The Stargazer (星の鏡と佇む少女) [Curved Water Masterpiece]
 * 
 * 仕様:
 * 1. 配列長は毎フレーム 100% 厳密に固定（総数: ${totalCount} 点）。
 * 2. 満天の星空・天の川銀河光芒・5種の大星・全身上下反転水鏡・流麗な半円アーチ曲線の水面を描画。
 */
...
console.log('Successfully written curved water particle/stargazer.js!');
